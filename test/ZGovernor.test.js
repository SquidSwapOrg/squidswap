...
contract('Governor', ([alice, minter, dev]) => {
    it('should work', async () => {
        ...
        await this.squid.delegate(dev, { from: dev });
        this.chef = await SquidChef.new(this.squid.address, dev, '100', '0', '0', { from: alice });
        ...
        // Perform another deposit to make sure some SQUIDs are minted in that 1 block.
        await this.chef.deposit(0, '100', { from: minter });
